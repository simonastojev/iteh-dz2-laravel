...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Blogs for app devs</title>
        ...
        <style>
            /*! normalize.css v8.0.1 | MIT License | github.com/necolas/normalize.css */html{line-height:1.15;
                ...
                *,:after,:before{box-sizing:border-box;border:0 solid #e2e8f0}
                ...
                .bg-gray-100{--bg-opacity:1;background-color:#e7dd51;background-color:rgba(247,250,252,var(--bg-opacity))}
                ...
                @media (prefers-color-scheme:dark){
                    .dark\:bg-gray-800{--bg-opacity:1;background-color:#ec8eec}
                    .dark\:bg-gray-900{--bg-opacity:1;background-color:#e7dd51}
                    .dark\:border-gray-700{--border-opacity:1;border-color:#4a5568;border-color:rgba(74,85,104,var(--border-opacity))}
                    .dark\:text-white{--text-opacity:1;color:rgb(0, 0, 0)}
                    .dark\:text-gray-400{--text-opacity:1;color:rgb(54, 54, 54)}
                }
        </style>
        <style>
            body {
    ...
    <body class="antialiased">
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center sm:pt-0">
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <div class="flex justify-center pt-8 sm:justify-start sm:pt-0 center">             
                        <h1>Welcome</h1>
                </div>
                    ...
                    <div class="grid grid-cols-1">
                        <div class="p-6">
                            <div class="flex items-center">
                                <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" class="w-8 h-8 text-white-400"><path d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"></path></svg>
                                <div class="ml-4 text-lg leading-7 font-semibold underline text-gray-900 dark:text-white">Articles for app devs</div>
                            </div>
